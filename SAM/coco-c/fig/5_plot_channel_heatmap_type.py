...
sns.heatmap(heatmap_data, cmap="YlOrRd", vmin=0.0, vmax=3.0, cbar_kws={'label': 'Mean Absolute Deviation'}, xticklabels=12, ax=ax)
...
# 저장 파일명
save_path = f"../analysis/sam_fig2_channel_heatmap_{target_corruption}.png"
